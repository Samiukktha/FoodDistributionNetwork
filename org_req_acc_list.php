<?php
    ...
    $sql="select distinct(sname) from request where oname='$orgname' and req='Accepted'";
    $result=mysqli_query($conn,$sql);
                  ...
                  <table style="width:100%"> 
                    ...
                    <tr>
                      ...
                      ?>
                        ...
                        <?php 
                        $s="select * from request where oname='$orgname' and req='Accepted' and sname='$sname'";
                        ...
                        <td>Accepted.</br>Waiting for Pick-Up</td>
