<?php
    ...
    $sql1="select * from request where sname='$sname' and fname='$fname' and oname='$oname' and req='Waiting'";
...
<html>
  ...
  <body>
    <section class="header">
      <nav>
      <a href=""><img src=<?php echo $i; ?> /></a><p style="color:white; padding-left:10px;"><?php echo $oname; ?></p>
        <div class="nav-links">
        <ul>
      ...
      <p style="text-align:left;"><a href="org_req.php?user=<?php echo $user; ?>" style="color:black; text-decoration:none; ">&lt; Back</a></p>
        <h2>Request Edit:</h2></br>
        <form name="form" method="POST" action="logic_org_req_edit.php" enctype="multipart/form-data">

            <img src='<?php echo $fpic; ?>'></br>
            Food Product: <?php echo $fname; ?></br>
            Food Type: <?php echo $ftype; ?></br>
            Per portion feed: <?php echo $pfc; ?></br>
            Stock available: <?php echo $s_qty; ?></br></br>
            
            <label>Enter Quantity:</label><span style="color:red;"> *</span>
            <input type="number" id="qty" name="qty" maxlength="10" style="width:165px;" max="<?php echo $s_qty; ?>"  value="<?php echo $r_qty ?>" required autofocus ></br></br>
            ...
            <input type="hidden" name="oname" id="oname" value="<?php echo $oname; ?>">
            
            <input type="submit" id="btn" value=" Confirm Change " name="submit" >
</form>
</form>
</div>
    </section>
